...
void draw() {
  ...
  // store init point and loop until you reach there again? Display number as {n/d} (frac) and (n/d) (decimal)?
...
float cust_cos(int n, float t) {
  return 0;
}

float cust_sin(int n, float t) {
  return 0;
}
