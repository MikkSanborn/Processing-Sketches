...
public final class Picture implements ActionListener {
   ...
   /**
     ...
     */
    public void set(int col, int row, Color colorr) {
        validateColumnIndex(col);
        validateRowIndex(row);
        if (colorr == null) throw new IllegalArgumentException("color argument is null");
        int rgb = colorr.getRGB();
        setRGB(col, row, rgb);
    }
...
// Last updated: Wed Oct 28 06:57:30 EDT 2020.
